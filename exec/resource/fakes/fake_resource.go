...
type FakeResource struct {
	...
	PutStub        func(atc.Source, atc.Params, io.Reader) resource.VersionedSource
...
func (fake *FakeResource) Put(arg1 atc.Source, arg2 atc.Params, arg3 io.Reader) resource.VersionedSource {
	fake.putMutex.Lock()
...
func (fake *FakeResource) PutArgsForCall(i int) (atc.Source, atc.Params, io.Reader) {
	fake.putMutex.RLock()
	defer fake.putMutex.RUnlock()
